...
const MOTIVATIONS = [
  ...
  // ETHICS (additional)
  { quote: "Integrity is doing right when nobody knows.", sub: "Ethics." },
  { quote: "Character is built through daily choices.", sub: "Ethics." },
  { quote: "Trust is earned one decision at a time.", sub: "Ethics." },
  { quote: "Values guide us when rules are insufficient.", sub: "Ethics." },
  { quote: "Honour begins with honesty.", sub: "Ethics." },
  { quote: "Shortcuts often create longer problems.", sub: "Ethics." },
  { quote: "The easy path is not always the right path.", sub: "Ethics." },
  { quote: "Integrity remains constant under pressure.", sub: "Ethics." },
  { quote: "Ethical decisions strengthen institutions.", sub: "Ethics." },
  { quote: "Credibility takes years to build and moments to lose.", sub: "Ethics." },
  { quote: "Do what is right, not what is popular.", sub: "Ethics." },
  { quote: "A reputation is built by repeated actions.", sub: "Ethics." },
  { quote: "Values are tested when circumstances are difficult.", sub: "Ethics." },
  { quote: "Character outlasts achievement.", sub: "Ethics." },
  { quote: "Integrity is leadership without an audience.", sub: "Ethics." },
  { quote: "Trustworthy people build trustworthy teams.", sub: "Ethics." },
  { quote: "Truth requires courage.", sub: "Ethics." },
  { quote: "Ethics begin before decisions become visible.", sub: "Ethics." },
  { quote: "Honour your commitments, especially the small ones.", sub: "Ethics." },
  { quote: "The right decision is often the harder one.", sub: "Ethics." },
  // CARE FOR SOLDIERS (additional)
  { quote: "People perform best when they feel valued.", sub: "Care for Soldiers." },
  { quote: "Know your people before you need them.", sub: "Care for Soldiers." },
  { quote: "Strong teams are built on genuine concern.", sub: "Care for Soldiers." },
  { quote: "Care builds trust. Trust builds teams.", sub: "Care for Soldiers." },
  { quote: "Leadership starts with understanding people.", sub: "Care for Soldiers." },
  { quote: "Listen first. Lead better.", sub: "Care for Soldiers." },
  { quote: "Every soldier deserves dignity and respect.", sub: "Care for Soldiers." },
  { quote: "The welfare of the team matters.", sub: "Care for Soldiers." },
  { quote: "People remember leaders who cared.", sub: "Care for Soldiers." },
  { quote: "Care strengthens commitment.", sub: "Care for Soldiers." },
  { quote: "Invest time in people.", sub: "Care for Soldiers." },
  { quote: "Trust grows through genuine concern.", sub: "Care for Soldiers." },
  { quote: "A strong team looks after one another.", sub: "Care for Soldiers." },
  { quote: "Empathy and standards can coexist.", sub: "Care for Soldiers." },
  { quote: "Know the person, not just the appointment.", sub: "Care for Soldiers." },
  { quote: "Care is a force multiplier.", sub: "Care for Soldiers." },
  { quote: "Great leaders develop people, not dependence.", sub: "Care for Soldiers." },
  { quote: "A cared-for team is a resilient team.", sub: "Care for Soldiers." },
  { quote: "Take an interest in people beyond the task.", sub: "Care for Soldiers." },
  { quote: "The mission succeeds through people.", sub: "Care for Soldiers." },
]
